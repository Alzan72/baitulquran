...
<form action="daftar-action-admin.php" method="post" style="margin: bottom 100px;">
<div class="form-body">
        <div class="row">
                    ...
                    <div class="form-items">
                        ...
                        <input type="hidden" name="id">
                            ...
                            <div class="col-md-12">
                                ...
                                <input class="form-control" type="number" name="nohp" placeholder="Masukkan nomor hp" required>
